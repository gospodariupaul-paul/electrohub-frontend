...
export default function HomePage() {
  ...
  useEffect(() => {
    ...
    fetch(`${API_URL}/conversations/unread`, {
      credentials: "include",
    })
      .then((res) => res.json())
      .then((data) => {
  ...
  useEffect(() => {
    ...
    axios
      .get(`${API_URL}/users/online`, {
        withCredentials: true,
      })
      .then((res) => setOnlineUsers(res.data.length ?? 0))
      .catch(() => {});
  }, []);
              ...
              <div className="grid md:grid-cols-3 gap-4">
                {[
                  ...
                  >
                    ...
                    <button className="mt-3 text-xs px-3 py-1.5 rounded-lg bg-cyan-500 text_black font-semibold hover:bg-cyan-400">
                      Adaugă în coș
                    </button>
                  </div>
                ))}
        ...
        <footer className="border-t border-white/10 bg-black/60 mt-8">
          <div className="max-w-6xl mx-auto px-4 py-5 flex flex-col md:flex-row gap-3 md:items-center md:justify-between text-[11px] text-white/50">
            ...
            <div className="flex gap-2">
              ...
              <button className="px-3 py-1.5 rounded-lg border border_white/15 hover:border-white/40">
