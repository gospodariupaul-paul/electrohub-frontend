    ...
    return (
      <div className="w-full py-10 flex justify-center gap-6">
        {[1, 2, 3].map((i) => (
          <div
            key={i}
            className="w-[240px] h-[420px] bg-white/5 border border-white/10 rounded-xl animate-pulse"
          >
  ...
  return (
    <div className="w-full py-10">
      <Swiper
        ...
        slidesPerView={"auto"}
        autoplay={{ delay: 2200 }}
        speed={900} // ⭐ animație smooth între slide-uri
        coverflowEffect={{
          rotate: 35,
          stretch: 0,
          depth: 180,
        ...
        {products.map((p) => (
          ...
          >
            ...
            <Link href={`/product/${p.id}`} className="flex flex-col h-full relative z-10">
              ...
              {/* ⭐ Badge */}
              {p.tag && (
                <span className="absolute top-2 left-2 bg-cyan-500 text-black text-xs font-bold px-2 py-1 rounded">
                  {p.tag}
                </span>
              )}
              ...
              <div className="p-4 text-center flex flex-col gap-2">
                ...
                <button className="
                  ...
                  hover:bg-cyan-600/50 hover:border-cyan-300 
                  transition-all duration-300
                ">
                  Adaugă în coș
                </button>
